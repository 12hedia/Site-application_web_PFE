...
<a href="listeequipement.php?email=<?php echo $_GET['email'] ?>" target="container" onclick="com_click('tab4');"><div class="tabstab" id="tab4"><h1>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Equipements</h1></div></a>
<a href="actualite.php?email=<?php echo $_GET['email'] ?>" target="container" onclick="com_click('tab5');"><div class="tabstab" id="tab5"><h1>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Actualités</h1></div></a>
<a href="statistiquecentre.php?email=<?php echo $_GET['email'] ?>" target="container" onclick="com_click('tab6');"><div class="tabstab" id="tab6"><h1>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Suivi statistique de centre</h1></div></a>
<a href="listerepas.php?email=<?php echo $_GET['email'] ?>"  target="container" onclick="com_click('tab7');"><div class="tabstab" id="tab7"><h1>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Repas</h1></div></a>
<a href="listecompte.php?email=<?php echo $_GET['email'] ?>" target="container" onclick="com_click('tab8');"><div class="tabstab" id="tab8"  ><h1>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Gérer comptes</h1></div></a>
