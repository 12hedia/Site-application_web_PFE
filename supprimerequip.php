...
$email= $_GET['email'] ;
session_start();
$query=" DELETE FROM `equipement` WHERE `equipement`.`code_eq` ='".$_GET['id']."';";
 if(mysqli_query($con,$query)){
   ...
   <a  href='listeequipement.php?email=".$email."'   style='position:absolute; top:59px; left:200px'>  retours  </a>
